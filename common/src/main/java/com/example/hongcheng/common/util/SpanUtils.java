...
public final class SpanUtils {
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils append(Context context, @NonNull final CharSequence text) {
        apply(context, mTypeCharSequence);
        mText = text;
        return this;
    }
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendLine(Context context, @NonNull final CharSequence text) {
        apply(context, mTypeCharSequence);
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @NonNull final Bitmap bitmap) {
        return appendImage(context, bitmap, ALIGN_BOTTOM);
    }
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @NonNull final Bitmap bitmap, @Align final int align) {
        apply(context, mTypeImage);
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @NonNull final Drawable drawable) {
        return appendImage(context, drawable, ALIGN_BOTTOM);
    }
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @NonNull final Drawable drawable, @Align final int align) {
        apply(context, mTypeImage);
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @NonNull final Uri uri) {
        return appendImage(context, uri, ALIGN_BOTTOM);
    }
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @NonNull final Uri uri, @Align final int align) {
        apply(context, mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @DrawableRes final int resourceId) {
        return appendImage(context, resourceId, ALIGN_BOTTOM);
    }
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendImage(Context context, @DrawableRes final int resourceId, @Align final int align) {
        apply(context, mTypeImage);
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendSpace(Context context, @IntRange(from = 0) final int size) {
        return appendSpace(context, size, Color.TRANSPARENT);
    }
     ...
     * @return the single {@link SpanUtils} instance
     */
    public SpanUtils appendSpace(Context context, @IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(context, mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
    }

    private void apply(Context context, final int type) {
        applyLast(context);
        mType = type;
    }
