...
import com.example.hongcheng.common.constant.PermissionConstants;
...
public final class PermissionUtils {
     ...
     */
    public static PermissionUtils permission(Context context, @PermissionConstants.Permission final String... permissions) {
