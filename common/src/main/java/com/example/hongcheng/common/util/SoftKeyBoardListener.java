...
public class SoftKeyBoardListener {
    ...
    public final static class SoftKeyBoardListenerHolder {
        public final static SoftKeyBoardListener INSTANCE = new SoftKeyBoardListener();
    }

    public static SoftKeyBoardListener getInstance() {
        return SoftKeyBoardListenerHolder.INSTANCE;
    }
