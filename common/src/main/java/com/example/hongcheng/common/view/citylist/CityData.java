...
public class CityData {
    ...
    public static List<CityItem> getCityList() {
        ...
        try {
            ...
            for (int i = 0; i < ja1.length(); i++) {
                ...
                list.add(new CityItem(cityName, PingYinUtil.getPingYin(cityName)));
            }
    ...
    public static List<CityItem> getHotCityList() {
        List<CityItem> list = new ArrayList<CityItem>();
        for (int i = 0; i < hotCity.length; i++) {
            list.add(new CityItem(hotCity[i], PingYinUtil.getPingYin(hotCity[i])));
        }
        return list;
    }
}
