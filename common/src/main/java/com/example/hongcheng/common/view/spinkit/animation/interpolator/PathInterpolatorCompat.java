...
package com.example.hongcheng.common.view.spinkit.animation.interpolator;
...
public class PathInterpolatorCompat {
     ...
     * loop head_back on itself such that there can be two points sharing the same x coordinate.
     *
