...
//        editText.setBackgroundResource(bgcolor);
        ...
        editText.setBackgroundColor(context.getColor(R.color.white));
        editText.setTextSize(0);
//        editText.setJustificationMode();
...
//        params.weight = 1;
     ...
     */
    //强制显示或者关闭系统键盘
    public void showKeyBoard(final EditText txtSearchKey, final String status) {
